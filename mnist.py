...
def get_training_data_set():
    ...
    获得训练数据集
    '''
    image_loader = ImageLoader('E:/Project/train-images.idx3-ubyte', 60000)
    label_loader = LabelLoader('E:/Project/train-labels.idx1-ubyte', 60000)
...
def get_test_data_set():
    ...
    获得测试数据集
    '''
    image_loader = ImageLoader('E:/Project/t10k-images.idx3-ubyte', 10000)
    label_loader = LabelLoader('E:/Project/t10k-labels.idx1-ubyte', 10000)
    return image_loader.load(), label_loader.load()
